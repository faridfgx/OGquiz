...
const HQUIZ_BANK = [
  ...
  { category: 'ships', question: "Frigates begin with a default movement value that lets them skip equipping which module just to move?", options: ["Transmission Module", "Electronic Module", "Storage Module"], answer: "Transmission Module" },
  { category: 'ships', question: "What innate critical hit bonus do all Frigates carry?", options: ["+1%", "+5%", "+10%"], answer: "+1%" },
  { category: 'ships', question: "How many armor types can Frigate hulls use?", options: ["One", "Two", "Four"], answer: "Two" },
  { category: 'ships', question: "How many armor types can Cruiser hulls use?", options: ["Two", "Three", "Four"], answer: "Two" },
  { category: 'ships', question: "How many armor types can Battleship hulls use?", options: ["Two", "Three", "Four"], answer: "Four" },
  ...
  { category: 'ships', question: "Which type of Flagship is restricted to a single stack per fleet formation?", options: ["Federation Flagship", "Humaroid-Flagship", "Special Hull"], answer: "Humaroid-Flagship" },
  ...
  { category: 'weapons', question: "Which module can intercept incoming Missile or Ship-Based attacks before they land?", options: ["Powered Pulse Cannon", "Eos Phase Shift Shield", "Transmission Engine"], answer: "Powered Pulse Cannon" },
  ...
  // ══════════════════ ARMOR & DAMAGE ══════════════════
  { category: 'armor', question: "Which armor type minimizes damage from Heat and Explosive weapons?", options: ["Nano Armor", "Chrome Armor", "Regen Armor"], answer: "Nano Armor" },
  { category: 'armor', question: "Which armor type minimizes damage from Magnetic and Explosive weapons?", options: ["Neutralizing Armor", "Chrome Armor", "Nano Armor"], answer: "Neutralizing Armor" },
  { category: 'armor', question: "Which armor type minimizes damage from Heat and Kinetic weapons?", options: ["Regen Armor", "Chrome Armor", "Nano Armor"], answer: "Chrome Armor" },
  { category: 'armor', question: "Which armor type minimizes damage from Kinetic and Magnetic weapons?", options: ["Regen Armor", "Neutralizing Armor", "Chrome Armor"], answer: "Regen Armor" },
  ...
  { category: 'armor', question: "On the Commander skill scale, which grade represents an average pilot with no bonus or penalty?", options: ["S", "B", "D"], answer: "B" },
  ...
  { category: 'armor', question: "The Space-Time Magnetic Shield module is primarily built to defend against which damage type?", options: ["Magnetic", "Kinetic", "Heat"], answer: "Magnetic" },
  ...
  { category: 'ships', question: "In the game's internal data, the common low-tier commander type is labeled as which of these?", options: ["Spell", "Legendary", "Divine"], answer: "Spell" },
  ...
  { category: 'ships', question: "Which hull category is the Sparrow?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Frigate" },
  { category: 'ships', question: "Which hull category is the Cerberus?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Battleship" },
  { category: 'ships', question: "Which hull category is the Watchman?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Cruiser" },
  { category: 'ships', question: "Which hull category is the Dessicator Notus?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Frigate" },
  { category: 'ships', question: "Which hull category is the Genesis?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Battleship" },
  { category: 'ships', question: "Which hull category is the Wraith?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Cruiser" },
  { category: 'ships', question: "Which hull category is the Ultra Nwyfre?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Frigate" },
  { category: 'ships', question: "Which hull category is the Presidio of Glory?", options: ["Frigate", "Cruiser", "Battleship"], answer: "Battleship" },
  ...
  { category: 'ships', question: "Which hull category is the Valentine Victory?", options: ["Cruiser", "Special", "Flagship"], answer: "Special" },
  ...
  { category: 'weapons', question: "Which weapon category is Judgment?", options: ["Ballistic", "Directional", "Missile"], answer: "Ballistic" },
  { category: 'weapons', question: "Which weapon category is Avalanche?", options: ["Ballistic", "Directional", "Missile"], answer: "Directional" },
  { category: 'weapons', question: "Which weapon category is Zeus?", options: ["Directional", "Missile", "Ship-Based"], answer: "Missile" },
  { category: 'weapons', question: "Which weapon category is Widowmaker?", options: ["Missile", "Ship-Based", "Directional"], answer: "Ship-Based" },
  { category: 'weapons', question: "Which weapon category is Titan?", options: ["Ballistic", "Missile", "Ship-Based"], answer: "Ship-Based" },
  { category: 'weapons', question: "Which weapon category is Terminator?", options: ["Ballistic", "Directional", "Missile"], answer: "Missile" },
  { category: 'weapons', question: "Which weapon category is Cyclone?", options: ["Ballistic", "Directional", "Ship-Based"], answer: "Directional" },
  { category: 'weapons', question: "Which weapon category is Shadowflare?", options: ["Directional", "Missile", "Ship-Based"], answer: "Missile" },
  { category: 'weapons', question: "Which weapon category is Dark Specter?", options: ["Directional", "Missile", "Ship-Based"], answer: "Ship-Based" },
  { category: 'weapons', question: "Which weapon category is Bloodspur?", options: ["Ballistic", "Directional", "Missile"], answer: "Ballistic" },
  { category: 'weapons', question: "Which weapon category is Phantom Ray?", options: ["Ballistic", "Directional", "Ship-Based"], answer: "Directional" },
  { category: 'weapons', question: "Which weapon category is Hammerhead?", options: ["Ballistic", "Missile", "Ship-Based"], answer: "Ship-Based" },
];
